...
public class NoteController {
	...
	@RequestMapping("/")
	public String readList(ModelMap map){
	...
	public String saveNote(int noteId, String noteTitle, String noteContent, String noteStatus,ModelMap model)
	{
		Note note=new Note();
	...
	public RedirectView deleteNote(@RequestParam("noteId") int id){
